...
class User implements UserInterface, PasswordAuthenticatedUserInterface
{
    ...
    {
        $this->id_pokemon = new ArrayCollection();
    ...
    {
        if (!$this->id_pokemon->contains($idPokemon)) {
            $this->id_pokemon->add($idPokemon);
            $idPokemon->setUser($this);
        }
    ...
    {
        if ($this->id_pokemon->removeElement($idPokemon)) {
            // set the owning side to null (unless already changed)
            if ($idPokemon->getUser() === $this) {
                $idPokemon->setUser(null);
            }
        }
